...
@Component({
  selector: 'app-menu',
  imports:[NgIf,NgForOf,RouterLink,RouterLinkActive,CommonModule,NgFor],
...
export class MenuComponent {
  ...
  backendVisibleStarters: boolean[] = [];
  backendVisibleMainDishes: boolean[] = [];
  backendVisibleDrinks: boolean[] = [];

  toggleStarters(index: number): void {
    this.backendVisibleStarters[index] = !this.backendVisibleStarters[index];
  }

  toggleMainDishes(index: number): void {
    this.backendVisibleMainDishes[index] = !this.backendVisibleMainDishes[index];
  }

  toggleDrinks(index: number): void {
    this.backendVisibleDrinks[index] = !this.backendVisibleDrinks[index];
  }

  closeToggleStarters(index: number): void {
    this.backendVisibleStarters[index] = false;
  }

  closeToggleMainDishes(index: number): void {
    this.backendVisibleMainDishes[index] = false;
  }

  closeToggleDrinks(index: number): void {
    this.backendVisibleDrinks[index] = false;
  }
}
